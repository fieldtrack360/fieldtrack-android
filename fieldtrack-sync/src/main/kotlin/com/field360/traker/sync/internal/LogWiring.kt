...
internal fun newLogRecorder(
    ...
    // Read live too. The user can change the battery setting while the app is running, and
    // the point of the entry is what was true when the session started.
    backgroundRestrictions = {
        runCatching { tracker.permissions().backgroundRestrictions() }.getOrNull()
    },
